...
Shrek *createShrek() {
    ...
    newShrek->image.image[2][1] = SHREK_SPRITE_BODY;
    newShrek->image.image[2][3] = SHREK_SPRITE_ARMS_CLOSE;
    newShrek->image.image[2][4] = SHREK_SPRITE_LEFT;
    newShrek->image.image[3][1] = SHREK_SPRITE_RIGHT;
    newShrek->image.image[3][3] = SHREK_SPRITE_LEFT;
